...
// send
  ...
  _getProductDetails() async {
    ...
    if (mounted) {
      ...
      addOns = restaurants!.restaurant!.type!;
    }
  ...
  applyCode()async{
    print("oooo");
    var headers = {
      'Cookie': 'ci_session=59dd1a84elpmmaiabkhq5mujfuf1f0ja'
    };
    var request = http.MultipartRequest('POST', Uri.parse('https://developmentalphawizz.com/antsnest/api/check_promo_code'));
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
            ...
            child: Column(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("${restaurants!.restaurant!.cityName.toString()}",style: TextStyle(color: appColorBlack,fontSize: 15,),),
                    ),
                  ],
                ),
                Container(height: 5),
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Text("Add Review",style: TextStyle(color: appColorWhite,fontWeight: FontWeight.w500,fontSize: 15),),
                ),
              ),
              ],
            ),
         ...
         restaurants!.restaurant!.type!.isEmpty ? SizedBox.shrink() : Container(
                      ...
                      child: Card(
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("${restaurants!.restaurant!.type![i].type}"),
                              SizedBox(height: 5,),
                              Text(" \u{20B9} ${restaurants!.restaurant!.type![i].price}"),
                            ],
                          ),
                        ),
                      ),
                    ), 
           currentIndex == idList ? Positioned(
                        left: 1,
                        right: 1,
                        top: 1,
                        bottom: 1,
                  ...
                  Expanded(
                      child: Padding(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                              border: InputBorder.none, hintText: "Enter Coupan code"),
                        ),
                      )),
                ],
              ),
